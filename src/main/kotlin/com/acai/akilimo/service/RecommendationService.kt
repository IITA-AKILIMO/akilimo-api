...
constructor(private val restTemplate: RestTemplate,
    ...
    private fun prepareFertilizerPayload(recommendationRequest: RecommendationRequest, tempFertilizerList: LinkedHashMap<String, FertilizerList>): PlumberComputeRequest {
        ...
        if (fertilizerList.containsKey(EnumFertilizer.NPK_20_12_16_MG_2.name)) {
            val npkTwentySixteen = fertilizerList[EnumFertilizer.NPK_20_12_16_MG_2.name]!!
            requestPayloadPlumber.npkTwentyTwelveAvailable = npkTwentySixteen.selected
            requestPayloadPlumber.npkTwentyTwelveBagWeight = npkTwentySixteen.fertilizerWeight!!
            requestPayloadPlumber.npkTwentyTwelveCostPerBag = npkTwentySixteen.fertilizerCostPerBag
        }
